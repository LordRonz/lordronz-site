...
export const AnimatedBars = ({
  ...
  return (
    <div className='flex w-auto items-end overflow-hidden' {...rest}>
      ...
      <span
        id='bar2'
        className='mr-[3px] h-1 w-1 bg-primary-300 dark:bg-primary-500'
      />
      <span
        id='bar3'
        className='h-3 w-1 bg-primary-300 opacity-80 dark:bg-primary-500'
      />
    </div>
  );
};
  ...
  return (
    <>
      <div
        className={clsxm(
          !!data?.songUrl && 'box',
          'mb-8 flex w-full flex-row-reverse items-center justify-center space-x-0 px-2 py-1 sm:flex-row sm:space-x-2'
        )}
      >
        ...
        <div className='inline-flex flex-col truncate sm:flex-row'>
          {data?.songUrl ? (
            <a
