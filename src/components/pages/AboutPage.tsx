...
import { CLOUDINARY_CLOUDNAME } from '@/constants/cloudinary';
...
const AboutPage = () => {
  ...
  const heroImageUrl = buildUrl('lordronz-site/main/memoji-thonking-airpods', {
    cloud: {
      ...
      <section className={clsxm('my-16 flex flex-col justify-center')}>
        <article className='layout flex flex-col gap-y-6'>
          ...
          >
            ...
            <Marker>Node.js</Marker>, using <Marker>NGINX</Marker> as a reverse
            proxy, and deploying applications with <Marker>Docker</Marker>. I
            have also honed my frontend skills by completing projects with{' '}
            <Marker>Typescript</Marker>, <Marker>React</Marker>, and{' '}
            <Marker>React Native</Marker>. My preferred databases are{' '}
            <Marker>MongoDB</Marker>, <Marker>PostgreSQL</Marker>, and I have
            recently started using <Marker>FaunaDB</Marker> as my{' '}
            ...
            <Marker>Linux SysAdmin</Marker>, and I use it as my daily operating
            system. Recently, I had the privilege of enrolling in the Apple
            Developer Academy as a member of an esteemed cohort dedicated to
            mastering the art of app development within the Apple Ecosystem.{' '}
            <Marker>Swift</Marker> has become one of my favorite languages, and
            I have released several groundbreaking apps on the App Store.
          </p>
