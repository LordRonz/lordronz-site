---
title: 'Using custom Next.js route for i18n'
...
Note that we must ignore some routes such as the api route, \_next static, and
images. If we don't do this then undefined behavior will happen because for
every single file it will execute this middleware.
